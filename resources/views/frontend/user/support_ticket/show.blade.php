        ...
        <div class="card-header border-bottom-0">
            <div class="text-center text-md-left">
                ...
                <div class="mt-4 fs-14">
                    ...
                    <span class="badge badge-inline badge-gray ml-2 p-3 fs-12"
                        style="border-radius: 25px; min-width: 80px !important;"> {{ translate(ucfirst($ticket->status)) }}
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route("support_ticket.seller_store") }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <textarea class="aiz-text-editor rounded-0" name="reply"
                ...
                <div class="form-group mb-0 text-right">
                    <button type="submit" class="btn btn-sm btn-primary rounded-0 w-150px"
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="comment-header">
                                        ...
                                        <p class="text-muted text-sm fs-12 mt-2">
                                            {{ date("d.m.Y h:i:m", strtotime($ticketreply->created_at)) }}</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="comment-header">
                                    ...
                                    <p class="text-muted text-sm fs-12 mt-2">
                                        {{ date("d.m.Y h:i:m", strtotime($ticket->created_at)) }}</p>
                                </div>
                            </div>
                        </div>
                        <div>
