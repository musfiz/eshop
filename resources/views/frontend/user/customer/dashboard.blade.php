...
@section("panel_content")
    ...
    @endphp
    @if ($welcomeCoupon)
        <div class="alert alert-primary align-items-center border d-flex flex-wrap justify-content-between"
            ...
            <button class="btn btn-sm mt-3 mt-lg-0 rounded-4" onclick="copyCouponCode('{{ $welcomeCoupon->coupon_code }}')"
                style="background-color: #3490F3; color: white;">{{ translate("Copy coupon Code") }}</button>
        </div>
    @endif
            ...
            <div class="col-xl-8 col-md-6 mb-4">
                <div class="h-100"
                    ...
                    <div class="p-4 h-100 w-100 w-xl-50">
                        ...
                        @endphp
                        <p class="fs-14 fw-400 text-gray mb-1">{{ translate("Last Recharge") }}
                            <strong>{{ $last_recharge ? date("d.m.Y", strtotime($last_recharge->created_at)) : "" }}</strong>
                        </p>
        ...
        <div class="col mb-4">
            <div class="h-100">
                <div class="row h-100 @if (get_setting("wallet_system") != 1 && addon_is_activated("club_point")) row-cols-md-2 @endif row-cols-1">
                    <!-- Expenditure summary -->
                    <div class="col">
                        <div class="p-4 bg-primary @if (!addon_is_activated("club_point")) h-100 @endif"
                            ...
                            <div class="d-flex align-items-center pb-4 ">
                                    ...
                                    <g id="Group_25000" data-name="Group 25000" transform="translate(-926 -614)">
                                        ...
                                        <g id="Group_24786" data-name="Group 24786" transform="translate(701.466 93)">
                                            <path id="Path_32311" data-name="Path 32311"
                                                ...
                                                transform="translate(127.209 529.177)" fill="#fff" />
                                        </g>
                                    </g>
                                </svg>
                                <div class="ml-3 d-flex flex-column justify-content-between">
                                    ...
                                    <span
                                        class="fs-20 fw-700 text-white">{{ single_price(get_user_total_expenditure()) }}</span>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="p-4 bg-secondary-base">
                                <div class="d-flex align-items-center pb-4 ">
                                    ...
                                    <div class="ml-3 d-flex flex-column justify-content-between">
                                        <span
                                            class="fs-14 fw-400 text-white mb-1">{{ translate("Total Club Points") }}</span>
                ...
                <div class="d-flex align-items-center py-4 border-bottom">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                        <g id="Group_25000" data-name="Group 25000" transform="translate(-1367 -427)">
                            <path id="Path_32314" data-name="Path 32314" d="M24,0A24,24,0,1,1,0,24,24,24,0,0,1,24,0Z"
                ...
                <div class="d-flex align-items-center py-4 border-bottom">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                        <g id="Group_25000" data-name="Group 25000" transform="translate(-1367 -499)">
                            <path id="Path_32309" data-name="Path 32309" d="M24,0A24,24,0,1,1,0,24,24,24,0,0,1,24,0Z"
                            ...
                            <g id="Group_24772" data-name="Group 24772" transform="translate(1383 515)">
                                ...
                                <rect id="Rectangle_1603" data-name="Rectangle 1603" width="16" height="16"
                ...
                <div class="d-flex align-items-center py-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                        <g id="Group_25000" data-name="Group 25000" transform="translate(-1367 -576)">
                            <path id="Path_32315" data-name="Path 32315" d="M24,0A24,24,0,1,1,0,24,24,24,0,0,1,24,0Z"
                                transform="translate(1367 576)" fill="#85b567" />
                            <path id="_2e746ddacacf202af82cf4480bae6173" data-name="2e746ddacacf202af82cf4480bae6173"
                                ...
                                transform="translate(1379.5 588.5)" fill="#fff" stroke="#fff" stroke-width="0.25"
                                fill-rule="evenodd" />
                        </g>
                    </svg>
                    <div class="ml-3 d-flex flex-column justify-content-between">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="p-4 border h-100">
                    ...
                    @if ($customer_package != null)
                        ...
                        <p class="fs-14 fw-700 mb-3 text-primary">{{ translate("Current Package") }}:
                            {{ $customer_package->getTranslation("name") }}</p>
                    ...
                    @endif
                    <a href="{{ route("customer_packages_list_show") }}" class="btn btn-primary btn-block fs-14 fw-500"
                        style="border-radius: 25px;">{{ translate("Upgrade Package") }}</a>
                </div>
            </div>
        @endif
                ...
                @if (Auth::user()->addresses != null)
                    ...
                    @if ($address != null)
                        <ul class="list-unstyled mb-5">
                            ...
                            <li class="fs-14 fw-400 text-derk pb-1"><span>{{ $address->postal_code }} -
                                    {{ $address->city->name }},</span></li>
    ...
    <div class="row align-items-center mb-2 mt-1">
        ...
        <div class="col-6 text-right">
            <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary"
                href="{{ route("wishlists.index") }}">{{ translate("View All") }}</a>
        </div>
    </div>
    @php
                    ...
                    <div class="aiz-card-box col py-3 text-center border-right border-bottom has-transition hov-shadow-out z-1"
                        ...
                        <div class="position-relative h-140px h-md-200px img-fit overflow-hidden mb-3">
                            ...
                            <div class="absolute-top-right aiz-p-hov-icon">
                                <a href="javascript:void(0)" onclick="removeFromWishlist({{ $wishlist->id }})"
                            ...
                            <a class="cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-flex justify-content-center align-items-center"
                                ...
                                onclick="showAddToCartModal({{ $wishlist->product->id }})">{{ translate("Add to Cart") }}</a>
                        </div>
                        <!-- Product Name -->
