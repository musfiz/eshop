...
@section("panel_content")
    ...
    <ul class="nav nav-tabs nav-fill border-light">
        @foreach (get_all_active_language() as $key => $language)
            <li class="nav-item">
                <a class="nav-link text-reset rounded-0 @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
    ...
    <form class="" action="{{ route("customer_products.update", $product->id) }}" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" name="name"
                            value="{{ $product->getTranslation("name") }}" placeholder="{{ translate("Product Name") }}"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" name="unit"
                            value="{{ $product->getTranslation("unit") }}" placeholder="{{ translate("Product unit") }}"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control selectpicker" data-placeholder="{{ translate("Select a condition") }}"
                            ...
                            <option value="new" @if ($product->conditon == "new") selected @endif>{{ translate("New") }}
                            </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" name="location"
                            value="{{ $product->location }}" placeholder="{{ translate("Location") }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-from-label">{{ translate("Product Tag") }} <span
                            class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control aiz-tag-input rounded-0" name="tags[]"
        ...
        <div class="card rounded-0 shadow-none border">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" name="video_link"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="meta_title" value="{{ $product->meta_title }}"
                            class="form-control rounded-0" placeholder="{{ translate("Meta Title") }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" lang="en" value="{{ $product->unit_price }}" min="0"
                            step="0.01" class="form-control rounded-0" name="unit_price"
        ...
        <div class="mar-all text-right">
            <button type="submit" name="button"
                class="btn btn-primary rounded-0 px-4">{{ translate("Update Product") }}</button>
        </div>
    </form>
@endsection
