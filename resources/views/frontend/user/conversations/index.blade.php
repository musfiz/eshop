                                ...
                                <div class="col-auto col-lg-3">
                                    @if (Auth::user()->id == $conversation->sender_id)
                                        <h6 class="text-dark mb-2">
                                            @if ($conversation->receiver->shop != null)
                                                <a href="{{ route("shop.visit", $conversation->receiver->shop->slug) }}"
                                                    class="text-reset hov-text-primary fw-700 fs-14">{{ $conversation->receiver->shop->name }}</a>
                                            @else
                                                <span
                                                    class="text-dark fw-700 fs-14 mb-2">{{ $conversation->receiver->name }}</span>
                                            @endif
                                        </h6>
                                    @else
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col">
                                                    <h6 class="mt-0">
                                                        ...
                                                        @if (
                                                            (Auth::user()->id == $conversation->sender_id && $conversation->sender_viewed == 0) ||
