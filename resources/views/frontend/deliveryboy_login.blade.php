...
@section("content")
    <div class="h-100 bg-cover bg-center py-5 d-flex align-items-center"
        style="background-image: url({{ uploaded_asset(get_setting("delivery_boy_login_page_bg")) }})">
        <div class="container">
            <div class="row">
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <div class="mb-5 text-center">
                                ...
                                <h5 class="fs-14 fw-400 text-dark">{{ translate("Login To Your Delivery Boy Account") }}
                                </h5>
                            </div>
                            <form class="pad-hor" method="POST" role="form" action="{{ route("login") }}">
                                ...
                                <div class="mb-4 mt-4">
                                    <button type="submit"
                                        class="btn btn-primary btn-block fw-700 fs-14 rounded-4">{{ translate("Login") }}</button>
                                </div>
                            </form>
                            @if (env("DEMO_MODE") == "On")
                                <div class="mt-4">
