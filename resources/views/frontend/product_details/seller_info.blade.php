@if ($detailedProduct->added_by == "seller" && $detailedProduct->user->shop != null)
    <div class="border mb-4" style="background: #fcfcfd;">
        <div class="position-relative p-3 p-sm-4 text-left">
            ...
            <div class="mt-1">
                ...
                @if ($detailedProduct->added_by == "seller" && get_setting("vendor_system_activation") == 1)
                    <a href="{{ route("shop.visit", $detailedProduct->user->shop->slug) }}"
                        class="avatar avatar-md mr-2 overflow-hidden border float-left float-lg-none float-xl-left">
            ...
            <!-- Social Links -->
            @if (
                $detailedProduct->user->shop->facebook ||
                    $detailedProduct->user->shop->google ||
                    $detailedProduct->user->shop->twitter ||
                    $detailedProduct->user->shop->youtube)
                <div class="mt-3">
