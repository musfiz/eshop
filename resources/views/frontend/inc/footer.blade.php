    ...
    <div class="container">
        ...
        <div class="mt-3 mb-4">
            <a href="{{ route("home") }}" class="d-block">
                ...
                @else
                    <img class="lazyload h-45px" src="{{ asset("assets/img/placeholder-rect.jpg") }}"
                        data-src="{{ asset("assets/img/logo.png") }}" alt="{{ env("APP_NAME") }}" height="45">
                @endif
            </a>
        </div>
        <div class="row">
                        ...
                        <div class="">
                            <a href="{{ get_setting("play_store_link") }}" target="_blank"
                                ...
                                <img class="lazyload has-transition"
                                    ...
                                    data-src="{{ asset("assets/img/play.png") }}" alt="{{ env("APP_NAME") }}"
                                    height="44">
                            </a>
                        </div>
                        <div class="">
                            <a href="{{ get_setting("app_store_link") }}" target="_blank"
                                ...
                                <img class="lazyload has-transition"
                                    src="{{ asset("assets/img/placeholder-rect.jpg") }}"
                                    data-src="{{ asset("assets/img/app.png") }}" alt="{{ env("APP_NAME") }}"
                                    height="44">
                            </a>
                        </div>
                    </div>
