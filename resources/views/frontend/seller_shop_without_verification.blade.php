                ...
                <div class="col-md-6 mx-auto">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ route("shop.visit", $shop->slug) }}" class="overflow-hidden size-64px rounded-content"
                            ...
                            <img class="lazyload h-64px  mx-auto" src="{{ asset("assets/img/placeholder.jpg") }}"
                                data-src="{{ uploaded_asset($shop->logo) }}"
                                onerror="this.onerror=null;this.src='{{ static_asset("assets/img/placeholder.jpg") }}';">
                        </a>
                        <div class="ml-3">
                            <!-- Shop Name & Verification Status -->
                            <a href="{{ route("shop.visit", $shop->slug) }}" class="text-dark d-block fs-16 fw-700">
                                {{ $shop->name }}
                                <span class="ml-2">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="fs-16 fw-700 text-secondary">{{ date("d M Y", strtotime($shop->created_at)) }}
                                </div>
                            </div>
                        </div>
                    </div>
