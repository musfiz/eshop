                                        ...
                                        <ul class="mb-0 list-unstyled">
                                            ...
                                            @else
                                                ...
                                                @if (get_single_category($category_id)->parent_id != 0)
                                                    <li class="mb-3">
                                                        <a class="text-reset fs-14 fw-600 hov-text-primary"
                                                            href="{{ route("customer_products.category", get_single_category(get_single_category($category_id)->parent_id)->slug) }}">
                                                            <i class="las la-angle-left"></i>
                                                ...
                                                <li class="mb-3">
                                                    <a class="text-reset fs-14 fw-600 hov-text-primary"
                                                        href="{{ route("customer_products.category", get_single_category($category_id)->slug) }}">
                                                        <i class="las la-angle-left"></i>
                                                ...
                                                @foreach (\App\Utility\CategoryUtility::get_immediate_children_ids($category_id) as $key => $id)
                                                    <li class="ml-4 mb-3">
                                                        <a class="text-reset fs-14 hov-text-primary"
                                                            href="{{ route("customer_products.category", get_single_category($id)->slug) }}">{{ get_single_category($id)->getTranslation("name") }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                        </ul>
                        ...
                        <div class="text-left">
                            <div class="d-flex">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-md-block">
                                    <select class="form-control form-control-sm aiz-selectpicker rounded-0" name="condition"
                                        onchange="filter()">
                        ...
                        <div class="px-3">
                            <div
                                ...
                                @foreach ($customer_products as $key => $product)
                                    <div
                                        class="col overflow-hidden has-transition hov-shadow-out z-1 border-right border-bottom">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="absolute-top-left">
                                                    @if ($product->conditon == "new")
                                                        <span
                                                            class="badge badge-inline badge-info fs-13 fw-700 p-3 text-white"
                                                            style="border-radius: 20px;">{{ translate("New") }}</span>
                                                    @elseif($product->conditon == "used")
                                                        <span
                                                            class="badge badge-inline badge-secondary-base fs-13 fw-700 p-3 text-white"
