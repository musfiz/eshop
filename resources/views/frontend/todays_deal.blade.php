...
@section("content")
    <section class="mb-5" style="margin-top: 2rem;">
        <div class="container">
            ...
            @if (get_setting("todays_deal_banner") != null || get_setting("todays_deal_banner_small") != null)
                <div class="mb-4 overflow-hidden hov-scale-img d-none d-md-block">
                    <img src="{{ asset("assets/img/placeholder-rect.jpg") }}"
                        data-src="{{ uploaded_asset(get_setting("todays_deal_banner")) }}" alt="{{ env("APP_NAME") }} promo"
            ...
            <div class="px-3">
                <div
                    class="row row-cols-xxl-6 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-2 gutters-16 border-top border-left">
