                                    ...
                                    <a href="{{ route("flash-deals") }}"
                                        ...
                                        <span class="position-absolute top-0 left-0 p-2rem d-flex flex-column"
                                            ...
                                            <span class="fs-30 fw-700 text-{{ get_setting("flash_deal_card_text") }}"
                                                style="text-transform: uppercase;">{{ get_setting("flash_deal_card_bg_title") }}</span>
                                            <span
                                                class="fs-16 text-{{ get_setting("flash_deal_card_text") }}">{{ get_setting("flash_deal_card_bg_subtitle") }}</span>
                                        </span>
                                    </a>
                                </div>
                                <!-- Today's deal -->
                                <div class="carousel-box overflow-hidden hov-scale-img">
                                    <a href="{{ route("todays-deal") }}"
                                        ...
                                        <span class="position-absolute top-0 left-0 p-2rem d-flex flex-column"
                                            style="width: 70%">
                                            <span class="fs-30 fw-700 text-{{ get_setting("flash_deal_card_text") }}"
                                                style="text-transform: uppercase;">{{ get_setting("todays_deal_card_bg_title") }}</span>
                                            <span
                                                class="fs-16 text-{{ get_setting("flash_deal_card_text") }}">{{ get_setting("todays_deal_card_bg_subtitle") }}</span>
                                        </span>
                                    </a>
                                </div>
                                <!-- New Products -->
                                    ...
                                    <a href="{{ route("search", ["sort_by" => "newest"]) }}"
                                        ...
                                        <span class="position-absolute top-0 left-0 p-2rem d-flex flex-column"
                                            ...
                                            <span class="fs-30 fw-700 text-{{ get_setting("new_product_card_text") }}"
                                                style="text-transform: uppercase;">{{ get_setting("new_product_card_bg_title") }}</span>
                                            <span
                                                class="fs-16 text-{{ get_setting("new_product_card_text") }}">{{ get_setting("new_product_card_bg_subtitle") }}</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <section class="mt-2 mt-md-3 border h-100">
                            <div class="p-4">
                                ...
                                <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-rows="2" data-items="3"
                                    data-xxl-items="3" data-xl-items="2.5" data-lg-items="3.4" data-md-items="2.5"
