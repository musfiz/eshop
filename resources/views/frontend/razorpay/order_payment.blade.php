        ...
        <div class="container text-center">
            ...
            <form action="{!! route("api.razorpay.payment") !!}" method="POST" id='rozer-pay' style="display: none;">
                ...
                <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ env("RAZOR_KEY") }}"
                    data-amount={{ round($combined_order->grand_total) * 100 }} data-order_id="{{ $res->id }}" data-buttontext=""
                    data-name="{{ env("APP_NAME") }}" data-description="Cart Payment"
                    data-image="{{ uploaded_asset(get_setting("header_logo")) }}" data-prefill.name="{{ $user->name }}"
