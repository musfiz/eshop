            ...
            <div class="card install-card position-relative">
                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                    ...
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <h1 class="fs-21 fw-700 text-uppercase mt-2" style="color: #3d3d3d;">Eshop Update
                            Process</h1>
                        <p class="fs-12 fw-500" style="color:  #666; line-height: 18px;">You will need to know the following
                            items before proceeding.</p>
                    </div>
                    <ol class="list-group">
                        <li class="list-group-item fs-12 fw-600 d-flex align-items-center"
                    ...
                    <div class="d-flex mt-3">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <g id="Group_22706" data-name="Group 22706" transform="translate(-704 -571)">
                                    <g id="Rectangle_19036" data-name="Rectangle 19036" transform="translate(704 571)"
                                        fill="#fff" stroke="#ea4335" stroke-width="1">
                                    ...
                                    <g id="Group_22693" data-name="Group 22693" transform="translate(0 -12)">
                                        <g id="Group_22698" data-name="Group 22698">
                                            <rect id="Rectangle_19044" data-name="Rectangle 19044" width="1.5"
                                                height="5" rx="0.75"
                                                transform="translate(715.475 589.939) rotate(45)" fill="#ea4335" />
                                            <rect id="Rectangle_19111" data-name="Rectangle 19111" width="1.5"
                                                height="5" rx="0.75"
                                                transform="translate(716.536 591) rotate(135)" fill="#ea4335" />
                                            <rect id="Rectangle_19051" data-name="Rectangle 19051" width="8"
                                                height="1.5" rx="0.75" transform="translate(708 590.25)"
                                                fill="#ea4335" />
                                        </g>
                                    </g>
                                </g>
                        ...
                        <p class="ml-2 mb-0 fs-12 fw-500 text-justify text-gray-dark"
                            style="color: #666; line-height: 18px;">
                            Note: Go to your server and find the php <span
                                class="text-dark fw-900">extension/package</span> and disable <span
                                class="text-dark fw-900">pdo_mysql</span> then enable <span
                                class="text-dark fw-900">nd_mysqli</span> and <span
                                class="text-dark fw-900">nd_pdo_mysql</span> both for preventing value convert issue like
