        ...
        <div class="d-sm-flex">
            ...
            <div class="page-side-nav c-scrollbar-light px-3 py-2">
                <ul class="nav nav-tabs flex-sm-column border-0" role="tablist" aria-orientation="vertical">
                    ...
                    <!-- New Products -->
                    <li class="nav-item">
                        <a class="nav-link" id="new-product-tab" href="#new_product" data-toggle="tab"
                            data-target="#new_product" type="button" role="tab" aria-controls="new_product"
                            aria-selected="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="featured-categories-tab" href="#featured_categories" data-toggle="tab"
                            data-target="#featured_categories" type="button" role="tab"
                            aria-controls="featured_categories" aria-selected="false">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-4 border" style="background: #fcfcfc;">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Background Image") }}
                                                    (<small>{{ translate("Will be shown in Flash Deal Card into Slider section") }}</small>)</label>
                                                <div class="input-group " data-toggle="aizuploader" data-type="image">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input type="hidden" name="types[][{{ $lang }}]"
                                                        value="flash_deal_card_bg_image">
                                                    <input type="hidden" name="flash_deal_card_bg_image"
                                                        value="{{ get_setting("flash_deal_card_bg_image", null, $lang) }}"
                                                        class="selected-files">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="types[][{{ $lang }}]"
                                                    value="flash_deal_card_bg_title">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ translate("Title") }}"
                                                    name="flash_deal_card_bg_title"
                                                    value="{{ get_setting("flash_deal_card_bg_title", null, $lang) }}">
                                            </div>
                                            <!-- Subtitle -->
                                            <div class="form-group">
                                                <label
                                                ...
                                                <input type="hidden" name="types[][{{ $lang }}]"
                                                    value="flash_deal_card_bg_subtitle">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ translate("Subtitle") }}"
                                                    name="flash_deal_card_bg_subtitle"
                                                    value="{{ get_setting("flash_deal_card_bg_subtitle", null, $lang) }}">
                                            </div>
                                            <!-- Text Color -->
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Text Color") }}</label>
                                                <div class="input-group mb-3 d-flex">
                                                    @php
                                                        $flash_deal_card_text_color = get_setting(
                                                            "flash_deal_card_text",
                                                        );
                                                    @endphp
                                                    <input type="hidden" name="types[]" value="flash_deal_card_text">
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="flash_deal_card_text_light" class="magic-radio"
                                                            type="radio" name="flash_deal_card_text" value="light"
                                                            @if ($flash_deal_card_text_color == "light" || $flash_deal_card_text_color == null) checked @endif>
                                                        <label for="flash_deal_card_text_light"
                                                            class="mb-0 ml-2">{{ translate("Light") }}</label>
                                                    </div>
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="flash_deal_card_text_dark" class="magic-radio"
                                                            type="radio" name="flash_deal_card_text" value="dark"
                                                            @if ($flash_deal_card_text_color == "dark") checked @endif>
                                                        <label for="flash_deal_card_text_dark"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-4 border" style="background: #fcfcfc;">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Background Image") }}
                                                    (<small>{{ translate("Will be shown in Today's Deal Card into Slider section") }}</small>)</label>
                                                <div class="input-group " data-toggle="aizuploader" data-type="image">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text bg-soft-secondary">
                                                            {{ translate("Browse") }}</div>
                                                    ...
                                                    <input type="hidden" name="types[][{{ $lang }}]"
                                                        value="todays_deal_card_bg_image">
                                                    <input type="hidden" name="todays_deal_card_bg_image"
                                                        value="{{ get_setting("todays_deal_card_bg_image", null, $lang) }}"
                                                        class="selected-files">
                                                </div>
                                                <div class="file-preview box"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Title") }}</label>
                                                <input type="hidden" name="types[][{{ $lang }}]"
                                                    value="todays_deal_card_bg_title">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ translate("Title") }}"
                                                    name="todays_deal_card_bg_title"
                                                    value="{{ get_setting("todays_deal_card_bg_title", null, $lang) }}">
                                            </div>
                                            <!-- Subtitle -->
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Subtitle") }}</label>
                                                <input type="hidden" name="types[][{{ $lang }}]"
                                                    value="todays_deal_card_bg_subtitle">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ translate("Subtitle") }}"
                                                    name="todays_deal_card_bg_subtitle"
                                                    value="{{ get_setting("todays_deal_card_bg_subtitle", null, $lang) }}">
                                            </div>
                                            <!-- Text Color -->
                                            <div class="form-group">
                                                <label
                                                ...
                                                <div class="input-group mb-3 d-flex">
                                                    @php
                                                        $todays_deal_card_text_color = get_setting(
                                                            "todays_deal_card_text",
                                                        );
                                                    @endphp
                                                    <input type="hidden" name="types[]" value="todays_deal_card_text">
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="todays_deal_card_text_light" class="magic-radio"
                                                            type="radio" name="todays_deal_card_text" value="light"
                                                            @if ($todays_deal_card_text_color == "light" || $todays_deal_card_text_color == null) checked @endif>
                                                        <label for="todays_deal_card_text_light"
                                                            class="mb-0 ml-2">{{ translate("Light") }}</label>
                                                    </div>
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="todays_deal_card_text_dark" class="magic-radio"
                                                            type="radio" name="todays_deal_card_text" value="dark"
                                                            @if ($todays_deal_card_text_color == "dark") checked @endif>
                                                        <label for="todays_deal_card_text_dark"
                                                            class="mb-0 ml-2">{{ translate("Dark") }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-4 border" style="background: #fcfcfc;">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Background Image") }}
                                                    (<small>{{ translate("Will be shown in New Product Card into Slider section") }}</small>)</label>
                                                <div class="input-group " data-toggle="aizuploader" data-type="image">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text bg-soft-secondary">
                                                            {{ translate("Browse") }}</div>
                                                    ...
                                                    <input type="hidden" name="types[][{{ $lang }}]"
                                                        value="new_product_card_bg_image">
                                                    <input type="hidden" name="new_product_card_bg_image"
                                                        value="{{ get_setting("new_product_card_bg_image", null, $lang) }}"
                                                        class="selected-files">
                                                </div>
                                                <div class="file-preview box"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Title") }}</label>
                                                <input type="hidden" name="types[][{{ $lang }}]"
                                                    value="new_product_card_bg_title">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ translate("Title") }}"
                                                    name="new_product_card_bg_title"
                                                    value="{{ get_setting("new_product_card_bg_title", null, $lang) }}">
                                            </div>
                                            <!-- Subtitle -->
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Subtitle") }}</label>
                                                <input type="hidden" name="types[][{{ $lang }}]"
                                                    value="new_product_card_bg_subtitle">
                                                <input type="text" class="form-control"
                                                    placeholder="{{ translate("Subtitle") }}"
                                                    name="new_product_card_bg_subtitle"
                                                    value="{{ get_setting("new_product_card_bg_subtitle", null, $lang) }}">
                                            </div>
                                            <!-- Text Color -->
                                            <div class="form-group">
                                                <label
                                                ...
                                                <div class="input-group mb-3 d-flex">
                                                    @php
                                                        $new_product_card_text_color = get_setting(
                                                            "new_product_card_text",
                                                        );
                                                    @endphp
                                                    <input type="hidden" name="types[]" value="new_product_card_text">
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="new_product_card_text_light" class="magic-radio"
                                                            type="radio" name="new_product_card_text" value="light"
                                                            @if ($new_product_card_text_color == "light" || $new_product_card_text_color == null) checked @endif>
                                                        <label for="new_product_card_text_light"
                                                            class="mb-0 ml-2">{{ translate("Light") }}</label>
                                                    </div>
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="new_product_card_text_dark" class="magic-radio"
                                                            type="radio" name="new_product_card_text" value="dark"
                                                            @if ($new_product_card_text_color == "dark") checked @endif>
                                                        <label for="new_product_card_text_dark"
                                                            class="mb-0 ml-2">{{ translate("Dark") }}</label>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <form action="{{ route("business_settings.update") }}" method="POST"
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                <div class="row gutters-16">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-4 border" style="background: #fcfcfc;">
                                            <p class="fs-14 fw-500 mb-3">
                                                {{ translate("Featured Categories Section Settings") }}</p>
                                            <!-- Text Color -->
                                            <div class="form-group">
                                                <label
                                                    class="col-from-label fs-13 fw-500">{{ translate("Featured Categories Text Color") }}</label>
                                                <div class="input-group mb-3 d-flex">
                                                    @php
                                                        $featured_categories_text_color = get_setting(
                                                            "featured_categories_text",
                                                        );
                                                    @endphp
                                                    <input type="hidden" name="types[]"
                                                        value="featured_categories_text">
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="featured_categories_text_light" class="magic-radio"
                                                            type="radio" name="featured_categories_text" value="light"
                                                            @if ($featured_categories_text_color == "light" || $featured_categories_text_color == null) checked @endif>
                                                        <label for="featured_categories_text_light"
                                                            class="mb-0 ml-2">{{ translate("Light") }}</label>
                                                    </div>
                                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                                        <input id="featured_categories_text_dark" class="magic-radio"
                                                            type="radio" name="featured_categories_text" value="dark"
                                                            @if ($featured_categories_text_color == "dark") checked @endif>
                                                        <label for="featured_categories_text_dark"
                                                            class="mb-0 ml-2">{{ translate("Dark") }}</label>
                                                    </div>
                                                </div>
                                            </div>
