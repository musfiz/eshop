            ...
            <div class="card-body p-2rem">
                <form action="{{ route("business_settings.update") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                            <label class="aiz-megabox d-block mb-3">
                                <input value="classic" type="radio" name="homepage_select"
                                    @if (get_setting("homepage_select") == null || get_setting("homepage_select") == "classic") checked @endif>
                                <span class="d-block aiz-megabox-elem rounded-0 img-overlay">
                                    <div class="h-350px w-100 overflow-hidden">
                                        <img src="{{ asset("assets/img/pages/home-classic.png") }}" class="w-100"
                                            alt="home-page">
                                    </div>
                                </span>
                            </label>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                            <label class="aiz-megabox d-block mb-3">
                                <input value="metro" type="radio" name="homepage_select"
                                    @if (get_setting("homepage_select") == "metro") checked @endif>
                                <span class="d-block aiz-megabox-elem rounded-0 img-overlay">
                                    <div class="h-350px w-100 overflow-hidden">
                                        <img src="{{ asset("assets/img/pages/home-metro.png") }}" class="w-100"
                                            alt="home-page">
                                    </div>
                                </span>
                            </label>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                            <label class="aiz-megabox d-block mb-3">
                                <input value="minima" type="radio" name="homepage_select"
                                    @if (get_setting("homepage_select") == "minima") checked @endif>
                                <span class="d-block aiz-megabox-elem rounded-0 img-overlay">
                                    <div class="h-350px w-100 overflow-hidden">
                                        <img src="{{ asset("assets/img/pages/home-minima.png") }}" class="w-100"
                                            alt="home-page">
                                    </div>
                                </span>
                            </label>
