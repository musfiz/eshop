                ...
                <div class="row">
                        ...
                        <label class="aiz-megabox d-block mb-3">
                            ...
                            <span class="d-block aiz-megabox-elem rounded-0 img-overlay">
                                <div class="h-190px w-100 overflow-hidden">
                                    <img src="{{ asset("assets/img/authentication_pages/boxed.png") }}" class="w-100"
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                        <label class="aiz-megabox d-block mb-3">
                            ...
                            <span class="d-block aiz-megabox-elem rounded-0 img-overlay">
                                <div class="h-190px w-100 overflow-hidden">
                                    <img src="{{ asset("assets/img/authentication_pages/free.png") }}" class="w-100"
                                        alt="authentication-page">
                                </div>
                            </span>
                        </label>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                        <label class="aiz-megabox d-block mb-3">
                            ...
                            <span class="d-block aiz-megabox-elem rounded-0 img-overlay">
                                <div class="h-190px w-100 overflow-hidden">
                                    <img src="{{ asset("assets/img/authentication_pages/focused.png") }}" class="w-100"
                                        alt="authentication-page">
                                </div>
                            </span>
                        </label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="admin_login_page_image"
                                value="{{ get_setting("admin_login_page_image") }}" class="selected-files">
                        </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group " data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="customer_login_page_image"
                                value="{{ get_setting("customer_login_page_image") }}" class="selected-files">
                        </div>
                        <div class="file-preview box"></div>
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group " data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="customer_register_page_image"
                                value="{{ get_setting("customer_register_page_image") }}" class="selected-files">
                        </div>
                        <div class="file-preview box"></div>
                    </div>
                    ...
                    @if (get_setting("vendor_system_activation") == 1)
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-group " data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="seller_login_page_image"
                                    value="{{ get_setting("seller_login_page_image") }}" class="selected-files">
                            </div>
                            <div class="file-preview box"></div>
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-group " data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="seller_register_page_image"
                                    value="{{ get_setting("seller_register_page_image") }}" class="selected-files">
                            </div>
                            <div class="file-preview box"></div>
                        </div>
                    @endif
                    ...
                    @if (addon_is_activated("delivery_boy"))
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-group " data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="delivery_boy_login_page_image"
                                    value="{{ get_setting("delivery_boy_login_page_image") }}" class="selected-files">
                            </div>
                            <div class="file-preview box"></div>
                        </div>
                    @endif
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group " data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="forgot_password_page_image"
                                value="{{ get_setting("forgot_password_page_image") }}" class="selected-files">
                        </div>
                        <div class="file-preview box"></div>
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group " data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="password_reset_page_image"
                                value="{{ get_setting("password_reset_page_image") }}" class="selected-files">
                        </div>
                        <div class="file-preview box"></div>
                    </div>
                    ...
                    @if (addon_is_activated("otp_system"))
                        <div class="form-group col-lg-6">
                            <label
                                class="from-label fs-13">{{ translate("Phone Number Verification Page Image") }}</label>
                            <div class="input-group " data-toggle="aizuploader" data-type="image">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-soft-secondary">{{ translate("Browse") }}</div>
                                </div>
                                ...
                                <input type="hidden" name="phone_number_verify_page_image"
                                    value="{{ get_setting("phone_number_verify_page_image") }}" class="selected-files">
                            </div>
                            <div class="file-preview box"></div>
                        </div>
                    @endif
