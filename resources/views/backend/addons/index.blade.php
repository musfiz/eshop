...
@section("content")
    <div class="">
        <div class="row ">
            ...
            <div class="col mt-3 mt-md-0 text-center text-md-right">
                <a href="https://nullcave.club/resources/active-ecommerce-cms-script-activeitzone.166/"
                    class="btn btn-primary mb-3 mb-sm-0 mx-3 mx-md-0 mr-lg-3" target="_blank">
                    {{ translate("Activate Addon Link") }}
                </a>
                <a href="{{ route("addons.create") }}"
                    class="btn btn-primary mx-3 mx-md-0">{{ translate("Install/Update Addon") }}</a>
            </div>
        </div>
    </div>
    <br>
                                        ...
                                        <div class="align-items-center d-flex flex-column flex-md-row">
                                            ...
                                            @if (env("DEMO_MODE") != "On")
                                                <div class="mr-md-3 ml-0 w-100 w-md-auto">
                                                    <p><small>{{ translate("Purchase code") }}:
                                                        </small>{{ $addon->purchase_code }}</p>
                                                </div>
                                            @endif
                                ...
                                @empty
                                    <li class="list-group-item">
                                        <div class="text-center">
                                            <img class="mw-100 h-200px" src="{{ asset("assets/img/nothing.svg") }}"
                                                alt="Image">
