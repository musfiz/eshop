...
@section("content")
    ...
    <form class="form form-horizontal mar-top" action="{{ route("digitalproducts.update", $product->id) }}" method="POST"
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-2 col-from-label">{{ translate("Product Name") }} <i
                    ...
                    <div class="card-body">
                        ...
                        @php
                            $start_date = $product->discount_start_date
                                ? date("d-m-Y H:i:s", $product->discount_start_date)
                                : null;
                            $end_date = $product->discount_end_date
                                ? date("d-m-Y H:i:s", $product->discount_end_date)
                                : null;
                        @endphp
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-2 col-from-label">{{ translate("Description") }} <i
                        ...
                        <div class="d-flex my-3">
                            <div class="radio mar-btm mr-5 ml-4 d-flex align-items-center">
                                <input id="fq_brought_select_products" type="radio"
                                    name="frequently_brought_selection_type" value="product"
                            ...
                            <div class="radio mar-btm mr-3 d-flex align-items-center">
                                <input id="fq_brought_select_category" type="radio"
                                    name="frequently_brought_selection_type" value="category"
                                    onchange="fq_brought_product_selection_type()"
                                                            ...
                                                            @foreach ($fq_brought_products as $fQBproduct)
                                                                <tr class="remove-parent">
                                                                    <input type="hidden" name="fq_brought_product_ids[]"
                                                                        value="{{ $fQBproduct->frequently_brought_product->id }}">
                                                                    <td class="w-150px pl-0"
                                                                        style="vertical-align: middle;">
                                                                        <p class="d-block size-48px">
                                                                            <img src="{{ uploaded_asset($fQBproduct->frequently_brought_product->thumbnail_img) }}"
                                                                                alt="{{ translate("Image") }}"
                                                                    ...
                                                                    <td style="vertical-align: middle;">
                                                                        {{ $fQBproduct->frequently_brought_product->main_category->name ?? translate("Category Not Found") }}
                                                                    </td>
