                ...
                <ul class="nav nav-tabs flex-sm-column border-0" role="tablist" aria-orientation="vertical">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="frequenty-brought-product-tab" href="#frequenty-brought-product"
                            data-toggle="tab" data-target="#frequenty-brought-product" type="button" role="tab"
                            aria-controls="frequenty-brought-product" aria-selected="false">
            ...
            <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
                ...
                <form action="{{ route("products.update", $product->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="tab-content">
                        ...
                        <!-- Frequently Brought Product -->
                        <div class="tab-pane fade" id="frequenty-brought-product" role="tabpanel"
                            aria-labelledby="frequenty-brought-product-tab">
                            <div class="bg-white p-3 p-sm-2rem">
                                <!-- tab Title -->
